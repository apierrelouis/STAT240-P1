...
```{r, echo = FALSE}
draft_data = read_csv("../data/draft_picks.csv")
...
Overall, there is a  strong correlation between draft pick and success in terms of fantasy points. Players that are taken earlier in the draft are more likely to score more fantasy points throughout their career.

...
261/360 of all running backs (72.5%) run between a 4.4 and 4.6 forty yard dash. Looking at RBs drafted top 50, 52/71 run between a 4.4 and 4.6 forty yard dash (73.2%). So, the proportions are not much different, it seems that running between a 4.4 and 4.6 does not influence where a player gets drafted. But, when you combine the two, there is clear correlation. 
